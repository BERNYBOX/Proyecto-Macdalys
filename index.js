...
lib.ssMetadata = [
		{name:"index _atlas_1", frames: [[0,0,800,400],[0,402,800,400]]},
		{name:"index _atlas_2", frames: [[0,0,1960,1470],[0,1472,976,549],[978,1472,1000,500]]}
];
...
(lib.Mapadebits3 = function() {
	this.initialize(ss["index _atlas_2"]);
	this.gotoAndStop(0);
...
(lib.Mapadebits5 = function() {
	this.initialize(ss["index _atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-5967,-653,1.099,1.204);

	this.instance_1 = new lib.Mapadebits7();
	this.instance_1.setTransform(-4868,-639,1.3738,1.4802);

	this.instance_2 = new lib.Mapadebits5();
	this.instance_2.setTransform(-2630,-653,1.3738,1.4709);

	this.instance_3 = new lib.Mapadebits3();
	this.instance_3.setTransform(-3769,-653,0.5811,0.4123);

	this.instance_4 = new lib.Mapadebits6();
	this.instance_4.setTransform(-1531.5,-654,1.1259,1.0727);
...
p.nominalBounds = new cjs.Rectangle(-5967,-654,5534.4,607.1);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(597));

	// marcara (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("EhV7AuGMAAAhcLMCr3AAAMAAABcLg");
	mask.setTransform(934.55,604.85);

	// animacion
	this.instance = new lib.Interpolación4("synched",0);
	this.instance.setTransform(817.15,963.85);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:1916.5,y:965},101).wait(27).to({x:1917.15,y:963.85},0).to({x:3025.55},73).wait(36).to({startPosition:0},0).to({x:4159.8},58).wait(28).to({startPosition:0},0).to({x:5236.55},108).wait(28).to({startPosition:0},0).to({x:6351.55},87).wait(51));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.text},{t:this.index},{t:this.servicios},{t:this.nosotros},{t:this.proyectos},{t:this.contacto}]}).to({state:[{t:this.shape},{t:this.text},{t:this.index},{t:this.servicios},{t:this.nosotros},{t:this.proyectos},{t:this.contacto}]},201).wait(396));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(597));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.instance_1}]}).wait(597));
...
// library properties:
lib.properties = {
	id: '61830EEFBA920F40BC4289F648E0552D',
	width: 1920,
	height: 1080,
	fps: 100,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Mapadebits1.png?1778552000735", id:"Mapadebits1"},
		{src:"images/index _atlas_1.png?1778552000704", id:"index _atlas_1"},
		{src:"images/index _atlas_2.png?1778552000704", id:"index _atlas_2"}
	],
	preloads: []
};
...
an.compositions['61830EEFBA920F40BC4289F648E0552D'] = {
